...
from app.core.database_unified import (
    ...
    APIEndpoint, APICredentials, APIRequest,
...
# Import healthcare records models separately
try:
    from app.modules.healthcare_records.models import Immunization
except ImportError:
    # Immunization model may not be available in some environments
    pass

# Import clinical workflows models
try:
    ...
    # Clinical workflows may not be available in some environments
    pass
