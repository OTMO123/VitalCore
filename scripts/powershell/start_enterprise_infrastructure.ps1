...
.EXAMPLE
    .\start_enterprise_infrastructure.ps1 -StartDocker -StartServer
    
.EXAMPLE  
    .\start_enterprise_infrastructure.ps1 -StartDocker -StartServer -RunTests
#>
...
if (-not $RunTests -and $StartServer) {
    ...
    Write-Host "   .\start_enterprise_infrastructure.ps1 -RunTests"
