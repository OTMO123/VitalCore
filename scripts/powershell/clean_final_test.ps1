# Clean Final Start and Test - No Unicode Characters
...
try {
    ...
    Write-Host ""
    Write-Host "Root Cause Analysis Complete:" -ForegroundColor Magenta
    ...
    Write-Host ""
    Write-Host "FINAL 5 WHYS ANALYSIS" -ForegroundColor Magenta
